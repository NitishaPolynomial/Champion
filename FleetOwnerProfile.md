...
flowchart TD
    ...
    K10 -- Success --> G["Back to Personal Detail"]
    G --> B1
    ...
    D15 -- Success --> G
    B1 -- Proceed to Vehicle Details --> V["Vehicle Details"]
    ...
    B1 -- All Sections Completed --> S["Profile Completion 100%"]
    B1 -- Any Section Pending --> T["Profile Still Incomplete - Show Pending Items"]
